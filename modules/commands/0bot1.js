...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["Yah This Bot creator : Aminul Sordar  link => https://www.facebook.com/br4nd.abir.your.next.bf.fan?mibextid=ZbWKwL"];
  var rand = tl[Math.floor(Math.random() * tl.length)]

    if ((event.body.toLowerCase() == "love you bot") || (event.body.toLowerCase() == "love u bot")) {
     return api.sendMessage("বস আমিনুল কোনো মেয়ের সাথে কথা বলতে না করেছে🙂🤖", threadID);
   };
    ...
    if ((event.body.toLowerCase() == "i love u bot") || (event.body.toLowerCase() == "i love you bot")) {
     return api.sendMessage("আমাকে না আমার বস আমিনুল কে ভালোবাসো😻🥀", threadID);
   };
